...
> say what that standard is. Saying
> "we target WCAG 2.2 AA" changes how findings land.
...
Where a user is fully locked out, meaning they
cannot reach a control, cannot read the state of one, or cannot escape a
trap, that reaches the blocker bar. Where it is friction
...
Content that changes without a page load, such as
validation errors, toasts and live counts, needs to be announced. Look for `aria-live`, or a focus move, or
